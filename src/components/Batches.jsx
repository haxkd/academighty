...
const Batches = () => {
    ...
    async function fetchCourses() {
        const querySnapshot = await getDocs(
            query(collection(db, "batches"), limit(pagecount), orderBy("BatchDate", "desc"))
        );
                                ...
                                return (
                                    <div key={index} className="col-lg-4 col-md-6 pb-4">
                                        <Link
                                            ...
                                            to={`/batch/${item.id}`}
                                        >
                                            <img className="img-fluid" src="/img/courses-4.jpg" alt="" style={{ height: "400px", width: "600px" }} />
